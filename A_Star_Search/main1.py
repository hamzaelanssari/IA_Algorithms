from A_Star_Search.Vertex import Vertex
from A_Star_Search.arc import arc
from A_Star_Search.Algorithm import A_Star_Search
import cmath
...
#from C
arc_C_G=arc(vertexG,4)
#from D
arc_D_G=arc(vertexG,5
